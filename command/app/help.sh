...
echo ""
echo "Options:"
echo "  clear-buffer        Clear the current logcat buffer from a device."
...
echo "  pidcat              Reformats the logcat output into a colorful stream that is much easier to visually follow."
...
echo "  watch               Get diagnostic output for a specified package running on a device."
echo "  watch-raw           View an unfiltered dump of log messages."
echo ""
