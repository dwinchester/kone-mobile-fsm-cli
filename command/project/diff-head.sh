...
show_help() {
  echo ""
  echo "Usage: kone project diff-head [options]"
  echo ""
  echo "Options:"
  ...
  echo ""
  echo "Examples:"
  echo "  kone project diff-head"
  echo "  kone project diff-head --numstat" 
  echo "  kone project diff-head --shortstat --submodule-only" 
  echo "  kone project diff-head --help" 
  echo ""
