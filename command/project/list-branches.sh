...
show_help() {
  echo ""
  echo "Description: If no non-option arguments are provided, existing branches are listed."
  echo "Usage: kone dev list-branches [options]"
  echo ""
  echo "Options:"
  ...
  echo ""
  echo "Examples:"
  echo "  kone dev list-branches"
  echo "  kone dev list-branches --all" 
  echo "  kone dev list-branches --submodule-only" 
  echo "  kone dev list-branches --all --submodule-only" 
  echo "  kone dev list-branches --help" 
  echo ""
